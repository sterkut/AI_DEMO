...
# ==========================================
with tab_coach:
    st.success("🎯 **Для Керівника відділу продажів:** ШІ не просто ставить бали, а підказує, які саме фрази менеджера завадили продажу. Дивіться блок 'Поради' праворуч.")
